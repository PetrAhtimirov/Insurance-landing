    ...
    return (
        <div className="bonus">
            <div className="bonus__inner container">
                <h2 className="bonus__title">Наши бонусы</h2>
                <div className="bonus__content">
                    <div className="bonus__card">
                        <h3 className="bonus__card__title">
                            Розыгрыши
                        </h3>
                        <p className="bonus__card__desc">
                            на билетов на мероприятия
                            и подарков от партнёров
                        </p>
                    </div>
                    <div className="bonus__card">
                        <h3 className="bonus__card__title">
